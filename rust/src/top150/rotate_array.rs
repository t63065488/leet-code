...
pub fn rotate_pop_and_insert(nums: &mut Vec<i32>, k: i32) {
    for i in 0..k {
        let temp: i32 = nums.pop().unwrap();
        nums.insert(0, temp);
    }
}
...
mod tests {
    ...
    #[test]
    pub fn test_rotate_slice_example1() {
        // Given
        let mut nums: Vec<i32> = vec![1,2,3,4,5,6,7];
        let k: i32 = 3;
        let expected_result: Vec<i32> = vec![5,6,7,1,2,3,4];
    ...
    #[test]
    pub fn test_rotate_slice_example2() {
        // Given
        let mut nums: Vec<i32> = vec![-1,-100,3,99];
        let k: i32 = 2;
        let expected_result: Vec<i32> = vec![3, 99, -1, -100];
    ...
    #[test]
    pub fn test_rotate_pop_and_insert_example1() {
        // Given
        let mut nums: Vec<i32> = vec![1,2,3,4,5,6,7];
        let k: i32 = 3;
        let expected_result: Vec<i32> = vec![5,6,7,1,2,3,4];
    ...
    #[test]
    pub fn test_rotate_pop_and_insert_example2() {
        // Given
        let mut nums: Vec<i32> = vec![-1,-100,3,99];
        let k: i32 = 2;
        let expected_result: Vec<i32> = vec![3, 99, -1, -100];
